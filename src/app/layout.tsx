...
import { CONTACT_DETAILS, QUICK_LINKS, SOCIAL_LINKS } from "@/app-config";
import { IoMail } from "react-icons/io5";

const logopath = '/assests/home/favicon.ico'
  ...
  return (
    <Box>
      ...
      <Flex position='absolute' w='full' p='3' justify='space-between' fontFamily='jua'>
        <Flex align='center' gap='2'>
          <Image src="/assests/home/favicon.ico" alt="logo" width="65px" />
  ...
  return (
    <Box bgColor='app.grey1' >
      <Flex aria-label="footer-top" maxW='1280px' mx='auto' p="10px" gap='5'  >
        ...
        <Box flex='2'>
          <Image src='/assests/home/logo-2.png' alt="logo-2" maxW="300px" mb='10px' />
          <br />
      ...
      < Flex arail-ablel="footer-bottom" p='4px' justify='space-between' bgColor='app.grey3' >
        ...
        <Flex align='center' gap='2'>
          ...
          <Link href='https:www.syntaxfit.com'><Image src="/assests/home/syntaxfit.png" alt="company_logo" /></Link>
        </Flex>
      </ Flex>
    </Box >
  )

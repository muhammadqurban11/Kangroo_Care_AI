...
function Page() {
  return (
    <Box>
      ...
      {/* <Box aria-label='Why-Choose-Us-Section' bgColor='gray.200'>
        <Heading justifySelf='center' color="app.primary" >Why Choose Us?</Heading> */}
      {/* <Flex position='absolute' mt='42' left='-10'> */}
      {/* <Image src='/assests/home/star.png' alt='star-image' w='48' /> */}
      {/* </Flex> */}
      {/* <Flex pos='relative' justify="space-between" align="center" bgColor='gray.200'>
          ...
          <Box flex="1" minWidth="320px" mb='20' mt='20' > */}
      {/* <Box border='4px solid' borderRadius='20px' width='150px' height='150px' transform="rotate(45deg)" ></Box> */}
      {/* <Image src="/assests/home/product-img.png" alt="products-image" w='full' h='full' />
            <Box pos='absolute' color='gray.300' transform='rotate(90deg)' top='15' left='0' >
              <SlStar size='64%' />
            </Box>
            <Box pos='absolute' color='gray.300' bottom='0' right='-10' >
              <SlStar size='64%' />
            </Box>
          </Box>
        </Flex>
      ...
      <Box aria-label="Why-Choose-Us-Section" pos="relative">
        <Heading justifySelf="center" color="app.primary"> Why Choose Us? </Heading>
        ...
        <Flex pos="relative" justify="space-between" align="center">
          ...
          <Box pos="absolute" zIndex="-1" right='0' left='0' bottom='0' top='0' color="gray.200">
            <Box pos="absolute" transform="rotate(64deg)" right='30' bottom='-16'>
              <SlStar size="64%" />
            </Box>
            <Box pos="absolute" zIndex="-1" left='-4' top='10' transform="rotate(90deg)">
              <SlStar size="64%" />
            </Box>
            <Box pos="absolute" zIndex="-1" left='48%' top='40%'>
